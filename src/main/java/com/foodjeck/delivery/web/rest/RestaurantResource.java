package com.foodjeck.delivery.web.rest;

import com.foodjeck.delivery.repository.RestaurantRepository;
import com.foodjeck.delivery.service.RestaurantService;
import com.foodjeck.delivery.service.dto.RestaurantDTO;
import com.foodjeck.delivery.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.foodjeck.delivery.domain.Restaurant}.
 */
@RestController
@RequestMapping("/api")
public class RestaurantResource {
    ...
    private static final String ENTITY_NAME = "restaurantdbRestaurant";
